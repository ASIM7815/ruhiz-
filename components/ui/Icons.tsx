...
const PATHS: Record<string, React.ReactNode> = {
  ...
  badge: (
    <path fill="currentColor" stroke="none" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
  ),
  location: (
  ...
  moon: <path strokeLinecap="round" strokeLinejoin="round" d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z" />,
  lock: (
  ...
  arrowLeft: <path strokeLinecap="round" strokeLinejoin="round" d="M17 16l-4-4m0 0l4-4m-4 4H3" />,
...
export function Icon({ name, filled = false, size = 20, className = '', ...rest }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
