...
begin
  ...
  with entries as (
    select k, v::float8 as v from jsonb_each_text(v_result)
  ), ranked as (
...
insert into public.posts (id, user_id, type, content, image_url, video_url, topics,
  ...
  ('b0000000-0000-4000-8000-000000000001', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a03', 'photo',
   ...
   '/images/ruhizhero.png', null, '{Life,Gratitude}', 124, 0, 12, 18, 18, 640, 640, now() - interval '2 hours'),
  ('b0000000-0000-4000-8000-000000000002', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a01', 'moment',
   ...
   null, null, '{Mental Health,Self Improvement}', 482, 0, 96, 132, 231, 2100, 2100, now() - interval '5 hours'),
  ('b0000000-0000-4000-8000-000000000003', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a08', 'video',
   ...
   null, 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4', '{Recovery,Fitness}', 356, 0, 44, 61, 149, 1750, 1750, now() - interval '9 hours'),
  ('b0000000-0000-4000-8000-000000000004', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a02', 'moment',
   ...
   null, null, '{Studying,Mental Health}', 208, 0, 17, 42, 87, 980, 980, now() - interval '14 hours'),
  ('b0000000-0000-4000-8000-000000000005', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a05', 'photo',
   ...
   '/images/FOOTER.png', null, '{Life,Gratitude}', 173, 0, 9, 55, 41, 760, 760, now() - interval '29 hours'),
  ('b0000000-0000-4000-8000-000000000006', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a04', 'moment',
   ...
   null, null, '{Career,Mental Health}', 641, 0, 120, 148, 302, 3100, 3100, now() - interval '38 hours'),
  ('b0000000-0000-4000-8000-000000000007', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a07', 'photo',
   ...
   '/images/login-side-image.png', null, '{Studying,Life}', 96, 0, 6, 28, 22, 430, 430, now() - interval '50 hours'),
  ('b0000000-0000-4000-8000-000000000008', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a06', 'video',
   ...
   null, 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4', '{Creativity,Relationships}', 289, 0, 31, 66, 74, 1200, 1200, now() - interval '62 hours'),
  ('b0000000-0000-4000-8000-000000000009', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a09', 'moment',
   ...
   null, null, '{Relationships}', 154, 0, 28, 37, 33, 680, 680, now() - interval '77 hours'),
  ('b0000000-0000-4000-8000-000000000010', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a0a', 'moment',
   ...
   null, null, '{Life,Gratitude}', 412, 0, 58, 96, 118, 1900, 1900, now() - interval '91 hours'),
  ('b0000000-0000-4000-8000-000000000011', null, 'moment',
   ...
   null, null, '{Mental Health,Self Improvement}', 64, 0, 4, 15, 21, 260, 260, now() - interval '12 hours'),
  ('b0000000-0000-4000-8000-000000000012', null, 'photo',
   E'Sunday reset: journal, tea, and the view from my window. Nothing productive happened and it was perfect. ☕',
   '/images/banner.png', null, '{Life,Gratitude}', 87, 0, 3, 19, 12, 300, 300, now() - interval '101 hours'),
  ('b0000000-0000-4000-8000-000000000013', null, 'video',
   ...
   null, 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4', '{Life,Self Improvement}', 45, 0, 2, 8, 8, 150, 150, now() - interval '144 hours'),
  ('b0000000-0000-4000-8000-000000000014', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a05', 'question',
   ...
   null, null, '{Mental Health}', 198, 0, 15, 44, 55, 1100, 1100, now() - interval '115 hours'),
  ('b0000000-0000-4000-8000-000000000015', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a03', 'photo',
   ...
   '/images/ruhiz.png', null, '{Life,Creativity}', 231, 0, 19, 58, 37, 900, 900, now() - interval '132 hours'),
  ('b0000000-0000-4000-8000-000000000016', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a01', 'video',
   ...
   null, 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4', '{Mental Health,Self Improvement}', 720, 0, 240, 254, 384, 4200, 4200, now() - interval '168 hours')
on conflict (id) do nothing;
